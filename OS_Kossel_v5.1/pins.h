...
// #define RAMPS_V_1_0
  ...
  #if MOTHERBOARD == 35
    #define HEATER_0_PIN       8    // ***Default = 8
  #else
    #define HEATER_0_PIN       10   // EXTRUDER 1  ***Default = 10
  #endif
  ...
  #if MOTHERBOARD == 35              // *** default only this statement "if MOTHERBOARD == 35"
    #define HEATER_BED_PIN     -1    // NO BED        *** default = -1
  #else
    #if MOTHERBOARD == 77
      #define HEATER_BED_PIN     9    // BED
    #else
      #define HEATER_BED_PIN     8    // BED   *** Default = 8
    #endif
  #endif
